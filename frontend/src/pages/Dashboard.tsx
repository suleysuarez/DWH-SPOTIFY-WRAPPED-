...
// ── PanelReveal — scroll-triggered entrance ───────────────────────────────────
function PanelReveal({ children, delay = 0 }: { children: React.ReactNode; delay?: number }) {
  return (
    <motion.div
...
function Note({ style }: { style?: React.CSSProperties }) {
  return (
    <span style={{ position: "absolute", fontSize: 22, opacity: 0.2, color: "#1DB954", pointerEvents: "none", ...style }}>♪</span>
  );
}
        ...
        {!loading && topGenres.length > 0 && (
          <Tilt3D intensity={6} style={{ position: "relative", flexShrink: 0, width: 400, height: 400 }}>
            ...
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie
                  data={topGenres} dataKey="count" cx="50%" cy="50%"
                  innerRadius={118} outerRadius={178} paddingAngle={4}
                ...
                >
                  {topGenres.map((_, i) => (
                    <Cell key={i} fill={GENRE_COLORS[i % GENRE_COLORS.length]}
                      stroke="rgba(7,9,15,0.6)" strokeWidth={2}
                    ...
                    >
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                          <span style={{ width: 10, height: 10, borderRadius: "50%", background: color, flexShrink: 0, boxShadow: isActive ? `0 0 16px ${glow}, 0 0 6px ${color}` : `0 0 4px ${color}55`, transition: "box-shadow 0.25s" }} />
                      ...
                      <div style={{ height: 6, background: "rgba(255,255,255,0.05)", borderRadius: 999, overflow: "hidden" }}>
                        <motion.div
                          initial={{ width: 0 }}
                          whileInView={{ width: `${(g.percentage / maxPct) * 100}%` }}
                          viewport={{ once: true }}
                          transition={{ delay: 0.3 + i * 0.1, duration: 0.8, ease: "easeOut" }}
                          style={{ height: "100%", borderRadius: 999, background: `linear-gradient(90deg, ${color}, ${color}99)`, boxShadow: isActive ? `0 0 12px ${glow}` : "none", transition: "box-shadow 0.25s" }}
                        />
                      </div>
                    </motion.div>
                  );
          ...
          <div style={{ ...P, background: "linear-gradient(135deg,#060d06 0%,#0a1a0a 40%,#0e1628 100%)", border: "1px solid rgba(29,185,84,0.25)" }}>
            ...
            <div style={{ position: "relative", zIndex: 2, flex: "0 0 50%", paddingRight: 40 }}>
              ...
              <motion.h1
                ...
                style={{ fontFamily: "DM Sans, sans-serif", fontSize: "clamp(4rem,7vw,7rem)", fontWeight: 900, lineHeight: 0.95, letterSpacing: "-2px", marginBottom: 20 }}
              >
              ...
              <motion.p
                ...
                style={{ fontFamily: "DM Sans, sans-serif", fontWeight: 800, fontSize: 18, color: "rgba(255,255,255,0.75)", marginBottom: 8 }}
              >
              ...
              <motion.p
                ...
                style={{ fontSize: 15, color: "rgba(255,255,255,0.4)", lineHeight: 1.8, marginBottom: 36 }}
              >
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.04, boxShadow: "0 0 60px rgba(29,185,84,0.7)" }}
                href="/etl"
            ...
            <motion.div
              ...
              style={{ position: "absolute", right: 0, bottom: 0, top: 0, width: "50%", zIndex: 1 }}
            >
                ...
                : topArtists.length === 0
                  ...
                  : topArtists.map((a, i) => (
                    <Tilt3D
                      key={a.id}
                      intensity={8}
                      style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 20, borderRadius: 14, padding: "8px 12px", background: "rgba(255,255,255,0.02)" }}
                    >
                      <motion.div
                  ...
                  : topTracks.map((t, i) => (
                    ...
                    >
                      <motion.div
                        ...
                        viewport={{ once: true }}
                        transition={{ delay: i * 0.1, duration: 0.5 }}
                        style={{ display: "flex", alignItems: "center", gap: 16, width: "100%", minWidth: 0 }}
                      >
          ...
          <div style={{ ...P, background: "linear-gradient(135deg,#0a0a12 0%,#181028 50%,#0f0f1a 100%)", border: "1px solid rgba(167,139,250,0.18)" }}>
            ...
            <div style={{ position: "relative", zIndex: 2, flex: "0 0 55%" }}>
              ...
              <p style={{ fontFamily: "DM Sans, sans-serif", fontSize: "clamp(4rem,8vw,8rem)", fontWeight: 900, lineHeight: 1, color: "#1DB954", marginBottom: 8, textShadow: "0 0 80px rgba(29,185,84,0.6)" }}>
                {stats.loading ? "..." : <AnimatedNumber value={totalMinutes} />}
              </p>
          ...
          <div style={{ ...P, background: "linear-gradient(135deg,#0a0a0a 0%,#0f0a1a 50%,#0a0f1a 100%)", border: "1px solid rgba(255,255,255,0.07)" }}>
            ...
            <div style={{ position: "relative", zIndex: 2, flex: "0 0 52%", paddingRight: 40 }}>
              ...
              <p style={{ fontFamily: "DM Sans, sans-serif", fontSize: "clamp(4rem,7vw,7rem)", fontWeight: 900, lineHeight: 1, color: "#fff", marginBottom: 8 }}>
                {stats.loading ? "..." : <AnimatedNumber value={totalArtists} />}
              </p>
              ...
              <Tilt3D intensity={5} style={{ display: "inline-flex", alignItems: "center", gap: 12, background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 14, padding: "14px 24px", cursor: "default" }}>
                <span style={{ fontSize: 20 }}>🎵</span>
                <span style={{ fontSize: 14, color: "rgba(255,255,255,0.5)", lineHeight: 1.6 }}>
                  {stats.loading ? "..." : <><AnimatedNumber value={totalPlays} /> reproducciones</>}<br />en tu historial
                </span>
              </Tilt3D>
            </div>
          ...
          <div style={{ ...P, background: "linear-gradient(135deg,#060d06 0%,#0a1a0a 40%,#0e1628 100%)", border: "1px solid rgba(29,185,84,0.25)" }}>
            ...
            <div style={{ position: "relative", zIndex: 2, flex: "0 0 50%", paddingRight: 40 }}>
              <motion.h2
                ...
                style={{ fontFamily: "DM Sans, sans-serif", fontSize: "clamp(2.5rem,5vw,5rem)", fontWeight: 900, color: "#fff", lineHeight: 1.05, marginBottom: 4 }}
              >
                Gracias por
              </motion.h2>
              <motion.p
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.7, ease: [0.22,1,0.36,1], delay: 0.1 }}
                style={{ fontFamily: "DM Sans, sans-serif", fontSize: "clamp(2.5rem,5vw,5rem)", fontWeight: 900, color: "#1DB954", marginBottom: 32, textShadow: "0 0 60px rgba(29,185,84,0.6)" }}
              >
                escuchar
              </motion.p>
